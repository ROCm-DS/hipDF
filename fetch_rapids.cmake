...
if(NOT EXISTS ${CMAKE_CURRENT_BINARY_DIR}/HIPDF_RAPIDS.cmake)
  ...
  if(${STATUS_CODE} EQUAL 0)
    message(STATUS "Downloaded 'HIPDF_RAPIDS.cmake' successfully!")
  else()
    file(REMOVE ${CMAKE_CURRENT_BINARY_DIR}/HIPDF_RAPIDS.cmake)
    # for debuging: message(FATAL_ERROR "Failed to download 'HIPDF_RAPIDS.cmake'. URL: ${URL}, Reason: ${ERROR_MESSAGE}")
    message(FATAL_ERROR "Failed to download 'HIPDF_RAPIDS.cmake'. Reason: ${ERROR_MESSAGE}")
  endif()
endif()
