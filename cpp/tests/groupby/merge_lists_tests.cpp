...
TYPED_TEST(GroupbyMergeListsTypedTest, InvalidInput)
{
  ...
  //todo(HIP): the original code uses lists_col{2}, but fails due to https://github.com/AMD-AI/hipdf/issues/23
...
TYPED_TEST(GroupbyMergeListsTypedTest, InputHasListsOfLists)
{
  ...
  auto const lists3 = lists_col{
    ...
    lists_col({lists_col{}}),                                          // key = 3, //todo(HIP): the original code lists_col{lists_col{}} fails because of https://github.com/AMD-AI/hipdf/issues/23
