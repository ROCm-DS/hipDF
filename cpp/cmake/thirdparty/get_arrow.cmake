...
function(find_libarrow_in_python_wheel PYARROW_VERSION)
  ...
  if(GLIBC_VERSION_MINOR LESS 28)
    target_compile_options(
      Arrow::Arrow INTERFACE "$<$<COMPILE_LANGUAGE:HIP,CXX>:-D_GLIBCXX_USE_CXX11_ABI=0>"
...
function(find_and_configure_arrow VERSION BUILD_STATIC ENABLE_S3 ENABLE_ORC ENABLE_PYTHON
  ...
  if(ENABLE_PARQUET)
    rapids_export_find_package_root(BUILD Parquet [=[${CMAKE_CURRENT_LIST_DIR}]=] EXPORT_SET cudf-exports)
    rapids_export_find_package_root(BUILD ArrowDataset [=[${CMAKE_CURRENT_LIST_DIR}]=] EXPORT_SET cudf-exports)
  endif()
