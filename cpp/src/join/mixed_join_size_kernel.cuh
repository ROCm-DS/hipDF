  ...
  cudf::device_span<cudf::size_type> matches_per_row)
{
  ...
  cg::thread_block_tile<1> this_thread = cg::this_thread(); //TODO(HIP): this uses a custom cg::this_thread() implementation from the CG extensions (not officially in ROCm)
